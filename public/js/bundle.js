...
exports.default = {
	...
	ready: function ready() {
		...
		$.post('/api/cat/getAll', {}).done(function (data) {
			if (data.status) self.$set('categorias', data.msg);
		}).fail(function () {
	...
	methods: {
		newPodcast: function newPodcast() {
			...
			$.post('/api/pod/new', data).done(function (data) {
				if (data.status) {
					alert('cadastrado com sucesso');
					location.href = '/';
				} else alert('Erro ao cadastrar novo podcast');
			});
		}
	}
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-55172986", module.exports)
  } else {
    hotAPI.update("_v-55172986", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
	...
	init: function init() {
		...
		this.$on('current_playing', function (id) {
			_this.current_playing = id;
			alert(id);
		});
	}
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-115b4de2", module.exports)
  } else {
    hotAPI.update("_v-115b4de2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./adicionarPodcastModal.vue":6,"./comentarios.vue":8,"./player.vue":11,"./searchFormulario.vue":13,"./setting.vue":14,"vue":4,"vue-hot-reload-api":2,"vueify/lib/insert-css":5}],8:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	methods: {
		...
		comentar: function comentar() {
			...
			$.post('/api/com/newcomment', data).done(function (data) {
				alert(data);
				console.log(data);
				_this.texto = '';
			});
...
exports.default = {
	...
	methods: {
		...
		view: function view() {
			...
			$.post('/api/epi/view', { id: this.episode._id }).done(function (done) {
				console.log(done);
			});
		},
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-28e9cf88", module.exports)
  } else {
    hotAPI.update("_v-28e9cf88", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
  ...
  ready: function ready() {
    ...
    $.post('/api/epi/getListLowerViewed').done(function (data) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-8bcf8924", module.exports)
  } else {
    hotAPI.update("_v-8bcf8924", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1b660eb0", module.exports)
  } else {
    hotAPI.update("_v-1b660eb0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
	...
	ready: function ready() {
		...
		$.post('/api/use/getInformation', {}).done(function (data) {
			console.log(data);
			if (data.status) {
				_this.nome = data.msg.displayName;
				_this.foto = 'http://graph.facebook.com/' + data.msg.id + '/picture?type=square';
				_this.logged = true;
			}
		});
	}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2b7e3611", module.exports)
  } else {
    hotAPI.update("_v-2b7e3611", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"./components/app.vue":7,"./components/home.vue":10,"./components/search.vue":12,"vue":4,"vue-router":3}]},{},[15]);
